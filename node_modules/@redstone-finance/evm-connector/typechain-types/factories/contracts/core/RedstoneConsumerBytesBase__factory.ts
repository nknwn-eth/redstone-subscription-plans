...
import type {
  ...
  RedstoneConsumerBytesBaseInterface,
} from "../../../contracts/core/RedstoneConsumerBytesBase";
...
export class RedstoneConsumerBytesBase__factory {
  static readonly abi = _abi;
  static createInterface(): RedstoneConsumerBytesBaseInterface {
    return new utils.Interface(_abi) as RedstoneConsumerBytesBaseInterface;
  }
  static connect(
    address: string,
