...
export interface StorageStructureModelInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "executeRequestWith10ArgsWithPrices",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "executeRequestWith3ArgsWithPrices",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "executeRequestWith5ArgsWithPrices",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "requestsWith10Args",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "requestsWith3Args",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "requestsWith5Args",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "sendRequestWith3Args",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "sendRequestWith5Args",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BytesLike>,
  ...
  encodeFunctionData(
    functionFragment: "setDeleteFromStorage",
...
export interface StorageStructureModel extends BaseContract {
  ...
  functions: {
    ...
    setDeleteFromStorage(
      _deleteFromStorage: PromiseOrValue<boolean>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
