...
export interface SampleProxyConnectorConsumerInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "aggregateValues"
      | "extractTimestampFromRedstonePayload"
      ...
      | "getValueManyParams"
      | "getValuesForDataFeedIds"
      | "latestSavedValue"
      | "processOracleValue"
      | "processOracleValues"
      | "returnMsgValue"
      | "revertWithTestMessage"
  ...
  encodeFunctionData(
    functionFragment: "extractTimestampFromRedstonePayload",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getComputationResult",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getValueForDataFeedId",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
    functionFragment: "getValueManyParams",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "getValuesForDataFeedIds",
    values: [PromiseOrValue<BytesLike>[]]
  ): string;
  encodeFunctionData(
    functionFragment: "latestSavedValue",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "processOracleValue",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
    functionFragment: "processOracleValues",
    values: [PromiseOrValue<BytesLike>[]]
  ): string;
  encodeFunctionData(
    functionFragment: "returnMsgValue",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "revertWithTestMessage",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "saveOracleValueInContractStorage",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
...
export interface SampleProxyConnectorConsumer extends BaseContract {
  ...
  functions: {
    ...
    getValueForDataFeedId(
      dataFeedId: PromiseOrValue<BytesLike>,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    getValueManyParams(
      dataFeedId: PromiseOrValue<BytesLike>,
      mockArg1: PromiseOrValue<BigNumberish>,
      mockArg2: PromiseOrValue<string>,
      mockArg3: PromiseOrValue<string>,
      mockArg4: PromiseOrValue<string>,
      mockArg5: PromiseOrValue<string>,
      mockArg6: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    updateUniqueSignersThreshold(
      newUniqueSignersThreshold: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
