...
export interface SampleProxyConnectorInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "checkOracleValue",
    values: [PromiseOrValue<BytesLike>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "checkOracleValueLongEncodedFunction",
    values: [PromiseOrValue<BytesLike>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getOracleValueUsingProxy",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
    functionFragment: "proxyEmptyError",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "proxyTestStringError",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "requireValueForward",
    values?: undefined
  ): string;
