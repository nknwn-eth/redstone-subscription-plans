...
export interface SampleNumericArrayLibInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "cachedMedian",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getCachedArray",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testArrayUpdatingInStorage",
    values: [PromiseOrValue<BigNumberish>[]]
  ): string;
  encodeFunctionData(
    functionFragment: "testMedianSelection",
    values: [PromiseOrValue<BigNumberish>[]]
  ): string;
  encodeFunctionData(
    functionFragment: "testSortTx",
    values: [PromiseOrValue<BigNumberish>[]]
  ): string;
