...
export interface SampleBitmapLibInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "getBitFromBitmap" | "setBitInBitmap"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "getBitFromBitmap",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "setBitInBitmap",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
...
export interface SampleBitmapLib extends BaseContract {
  ...
  functions: {
    getBitFromBitmap(
      ...
      bitIndex: PromiseOrValue<BigNumberish>,
