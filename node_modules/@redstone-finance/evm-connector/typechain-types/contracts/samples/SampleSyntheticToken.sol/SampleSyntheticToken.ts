...
export interface SampleSyntheticTokenInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "MAX_SOLVENCY",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MIN_SOLVENCY",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "SOLVENCY_PRECISION",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "balanceValueOf",
    values: [PromiseOrValue<string>]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "collateralValueOf",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface SampleSyntheticToken extends BaseContract {
  ...
  functions: {
    ...
    initialize(
      asset_: PromiseOrValue<BytesLike>,
