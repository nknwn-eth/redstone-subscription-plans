...
export interface SampleRedstoneConsumerBytesMockInterface
  ...
  encodeFunctionData(
    functionFragment: "aggregateByteValues",
  ...
  encodeFunctionData(
    functionFragment: "getValueSecurely",
...
export interface SampleRedstoneConsumerBytesMock extends BaseContract {
  ...
  functions: {
    aggregateByteValues(
      calldataPointersForValues: PromiseOrValue<BigNumberish>[],
      overrides?: CallOverrides
    ): Promise<[string]>;

    aggregateValues(
      calldataPointersToValues: PromiseOrValue<BigNumberish>[],
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { pointerToResultBytesInMemory: BigNumber }>;
