...
export interface RedstoneConsumerNumericMockInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "aggregateValues" | "extractTimestampsAndAssertAllAreEqual" | "getAllMockAuthorised" | "getAllMockExceptLastOneAuthorised" | "getAuthorisedMockSignerIndex" | "getAuthorisedSignerIndex" | "getDataServiceId" | "getUniqueSignersThreshold" | "validateTimestamp"): FunctionFragment;
...
export interface RedstoneConsumerNumericMock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: RedstoneConsumerNumericMockInterface;
...
//# sourceMappingURL=RedstoneConsumerNumericMock.d.ts.map