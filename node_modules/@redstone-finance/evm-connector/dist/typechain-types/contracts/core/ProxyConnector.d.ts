...
export interface ProxyConnectorInterface extends utils.Interface {
    functions: {
...
export interface ProxyConnector extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ProxyConnectorInterface;
...
//# sourceMappingURL=ProxyConnector.d.ts.map