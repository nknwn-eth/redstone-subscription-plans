...
export interface RedstoneConsumerBytesBaseInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "aggregateByteValues" | "aggregateValues" | "extractTimestampsAndAssertAllAreEqual" | "getAuthorisedSignerIndex" | "getDataServiceId" | "getUniqueSignersThreshold" | "validateTimestamp"): FunctionFragment;
