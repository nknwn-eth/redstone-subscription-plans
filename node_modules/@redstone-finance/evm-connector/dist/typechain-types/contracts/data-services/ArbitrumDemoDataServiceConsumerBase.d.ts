...
export interface ArbitrumDemoDataServiceConsumerBaseInterface extends utils.Interface {
    functions: {
...
export interface ArbitrumDemoDataServiceConsumerBase extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ArbitrumDemoDataServiceConsumerBaseInterface;
...
//# sourceMappingURL=ArbitrumDemoDataServiceConsumerBase.d.ts.map