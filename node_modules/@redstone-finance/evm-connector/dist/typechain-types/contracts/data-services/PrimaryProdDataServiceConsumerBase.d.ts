...
export interface PrimaryProdDataServiceConsumerBaseInterface extends utils.Interface {
    functions: {
...
export interface PrimaryProdDataServiceConsumerBase extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PrimaryProdDataServiceConsumerBaseInterface;
...
//# sourceMappingURL=PrimaryProdDataServiceConsumerBase.d.ts.map