...
export interface ArbitrumProdDataServiceConsumerBaseInterface extends utils.Interface {
    functions: {
...
export interface ArbitrumProdDataServiceConsumerBase extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ArbitrumProdDataServiceConsumerBaseInterface;
...
//# sourceMappingURL=ArbitrumProdDataServiceConsumerBase.d.ts.map