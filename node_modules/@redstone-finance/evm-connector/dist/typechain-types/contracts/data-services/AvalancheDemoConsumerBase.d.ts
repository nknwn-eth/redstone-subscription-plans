...
export interface AvalancheDemoConsumerBaseInterface extends utils.Interface {
    functions: {
...
export interface AvalancheDemoConsumerBase extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AvalancheDemoConsumerBaseInterface;
...
//# sourceMappingURL=AvalancheDemoConsumerBase.d.ts.map