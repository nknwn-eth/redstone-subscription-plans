...
export interface PrimaryDemoDataServiceConsumerBaseInterface extends utils.Interface {
    functions: {
...
export interface PrimaryDemoDataServiceConsumerBase extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PrimaryDemoDataServiceConsumerBaseInterface;
...
//# sourceMappingURL=PrimaryDemoDataServiceConsumerBase.d.ts.map