...
export interface KydServiceConsumerBaseInterface extends utils.Interface {
    functions: {
...
export interface KydServiceConsumerBase extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: KydServiceConsumerBaseInterface;
...
//# sourceMappingURL=KydServiceConsumerBase.d.ts.map