...
export interface StagingDemoDataServiceConsumerBaseInterface extends utils.Interface {
    functions: {
...
export interface StagingDemoDataServiceConsumerBase extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: StagingDemoDataServiceConsumerBaseInterface;
...
//# sourceMappingURL=StagingDemoDataServiceConsumerBase.d.ts.map