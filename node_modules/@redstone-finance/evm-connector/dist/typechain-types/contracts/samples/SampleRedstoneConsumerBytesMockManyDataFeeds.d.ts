...
export interface SampleRedstoneConsumerBytesMockManyDataFeedsInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "aggregateByteValues" | "aggregateValues" | "extractTimestampsAndAssertAllAreEqual" | "firstValue" | "getAllMockAuthorised" | "getAllMockExceptLastOneAuthorised" | "getAuthorisedMockSignerIndex" | "getAuthorisedSignerIndex" | "getDataServiceId" | "getUniqueSignersThreshold" | "save2ValuesInStorage" | "secondValue" | "validateTimestamp"): FunctionFragment;
...
export interface SampleRedstoneConsumerBytesMockManyDataFeeds extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SampleRedstoneConsumerBytesMockManyDataFeedsInterface;
...
//# sourceMappingURL=SampleRedstoneConsumerBytesMockManyDataFeeds.d.ts.map