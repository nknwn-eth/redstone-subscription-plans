...
export interface SampleProxyConnectorConsumerInterface extends utils.Interface {
    functions: {
        ...
        "extractTimestampFromRedstonePayload()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "aggregateValues" | "extractTimestampFromRedstonePayload" | "extractTimestampsAndAssertAllAreEqual" | "getAllMockAuthorised" | "getAllMockExceptLastOneAuthorised" | "getAuthorisedMockSignerIndex" | "getAuthorisedSignerIndex" | "getComputationResult" | "getDataServiceId" | "getUniqueSignersThreshold" | "getValueForDataFeedId" | "getValueManyParams" | "getValuesForDataFeedIds" | "latestSavedValue" | "processOracleValue" | "processOracleValues" | "returnMsgValue" | "revertWithTestMessage" | "revertWithoutMessage" | "saveOracleValueInContractStorage" | "updateUniqueSignersThreshold" | "validateTimestamp"): FunctionFragment;
    encodeFunctionData(functionFragment: "aggregateValues", values: [PromiseOrValue<BigNumberish>[]]): string;
    encodeFunctionData(functionFragment: "extractTimestampFromRedstonePayload", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "extractTimestampFromRedstonePayload", data: BytesLike): Result;
...
export interface SampleProxyConnectorConsumer extends BaseContract {
    ...
    populateTransaction: {
        ...
        extractTimestampFromRedstonePayload(overrides?: CallOverrides): Promise<PopulatedTransaction>;
