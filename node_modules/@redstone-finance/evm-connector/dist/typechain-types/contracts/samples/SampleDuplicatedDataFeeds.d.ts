...
export interface SampleDuplicatedDataFeedsInterface extends utils.Interface {
    functions: {
        ...
        "getValuesFromStorage()": FunctionFragment;
        "saveOracleValuesInStorage(bytes32[])": FunctionFragment;
        "validateTimestamp(uint256)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "aggregateValues" | "extractTimestampsAndAssertAllAreEqual" | "getAllMockAuthorised" | "getAllMockExceptLastOneAuthorised" | "getAuthorisedMockSignerIndex" | "getAuthorisedSignerIndex" | "getDataServiceId" | "getUniqueSignersThreshold" | "getValuesFromStorage" | "saveOracleValuesInStorage" | "validateTimestamp"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getValuesFromStorage", values?: undefined): string;
    encodeFunctionData(functionFragment: "saveOracleValuesInStorage", values: [PromiseOrValue<BytesLike>[]]): string;
    ...
    decodeFunctionResult(functionFragment: "getValuesFromStorage", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "saveOracleValuesInStorage", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "validateTimestamp", data: BytesLike): Result;
    events: {};
}
export interface SampleDuplicatedDataFeeds extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SampleDuplicatedDataFeedsInterface;
    ...
    functions: {
        ...
        saveOracleValuesInStorage(dataFeedIdsWithDuplicates: PromiseOrValue<BytesLike>[], overrides?: Overrides & {
    ...
    callStatic: {
        ...
        getUniqueSignersThreshold(overrides?: CallOverrides): Promise<number>;
        getValuesFromStorage(overrides?: CallOverrides): Promise<BigNumber[]>;
        saveOracleValuesInStorage(dataFeedIdsWithDuplicates: PromiseOrValue<BytesLike>[], overrides?: CallOverrides): Promise<void>;
        validateTimestamp(receivedTimestampMilliseconds: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
    ...
    populateTransaction: {
        ...
        getValuesFromStorage(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        saveOracleValuesInStorage(dataFeedIdsWithDuplicates: PromiseOrValue<BytesLike>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
...
//# sourceMappingURL=SampleDuplicatedDataFeeds.d.ts.map