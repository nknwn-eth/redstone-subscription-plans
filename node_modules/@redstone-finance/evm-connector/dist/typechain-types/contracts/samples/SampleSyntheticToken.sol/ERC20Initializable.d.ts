...
export interface ERC20InitializableInterface extends utils.Interface {
    functions: {
...
export interface ERC20Initializable extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC20InitializableInterface;
...
//# sourceMappingURL=ERC20Initializable.d.ts.map