...
export interface SampleForLocalhostMockTestInterface extends utils.Interface {
    functions: {
        "aggregateValues(uint256[])": FunctionFragment;
        "extractOracleValuesView(bytes32[])": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "aggregateValues" | "extractOracleValuesView" | "extractTimestampsAndAssertAllAreEqual" | "getAllMockAuthorised" | "getAllMockExceptLastOneAuthorised" | "getAuthorisedMockSignerIndex" | "getAuthorisedSignerIndex" | "getDataServiceId" | "getUniqueSignersThreshold" | "validateTimestamp"): FunctionFragment;
    encodeFunctionData(functionFragment: "aggregateValues", values: [PromiseOrValue<BigNumberish>[]]): string;
    encodeFunctionData(functionFragment: "extractOracleValuesView", values: [PromiseOrValue<BytesLike>[]]): string;
    ...
    decodeFunctionResult(functionFragment: "extractOracleValuesView", data: BytesLike): Result;
...
export interface SampleForLocalhostMockTest extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SampleForLocalhostMockTestInterface;
    ...
    functions: {
        ...
        extractOracleValuesView(dataFeedIds: PromiseOrValue<BytesLike>[], overrides?: CallOverrides): Promise<[BigNumber[]]>;
    ...
    populateTransaction: {
        ...
        extractOracleValuesView(dataFeedIds: PromiseOrValue<BytesLike>[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=SampleForLocalhostMockTest.d.ts.map