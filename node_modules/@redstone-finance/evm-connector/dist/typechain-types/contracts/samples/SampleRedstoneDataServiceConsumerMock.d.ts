...
export interface SampleRedstoneDataServiceConsumerMockInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "aggregateValues" | "extractTimestampsAndAssertAllAreEqual" | "firstValue" | "getAllMockAuthorised" | "getAllMockExceptLastOneAuthorised" | "getAuthorisedMockSignerIndex" | "getAuthorisedSignerIndex" | "getDataServiceId" | "getUniqueSignersThreshold" | "save2ValuesAndTimestampInStorage" | "save2ValuesInStorage" | "save2ValuesInStorageWithManualPayload" | "secondValue" | "timestampFromData" | "validateTimestamp"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "save2ValuesAndTimestampInStorage", values: [PromiseOrValue<BytesLike>[]]): string;
    ...
    encodeFunctionData(functionFragment: "timestampFromData", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "save2ValuesAndTimestampInStorage", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "timestampFromData", data: BytesLike): Result;
...
export interface SampleRedstoneDataServiceConsumerMock extends BaseContract {
    ...
    functions: {
        ...
        save2ValuesAndTimestampInStorage(dataFeedIds: PromiseOrValue<BytesLike>[], overrides?: Overrides & {
    ...
    callStatic: {
        ...
        getDataServiceId(overrides?: CallOverrides): Promise<string>;
        getUniqueSignersThreshold(overrides?: CallOverrides): Promise<number>;
        save2ValuesAndTimestampInStorage(dataFeedIds: PromiseOrValue<BytesLike>[], overrides?: CallOverrides): Promise<void>;
