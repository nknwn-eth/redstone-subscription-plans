...
export interface SampleKydServiceConsumerInterface extends utils.Interface {
    functions: {
        ...
        "getPassedKYDValue()": FunctionFragment;
        "getUniqueSignersThreshold()": FunctionFragment;
        "validateTimestamp(uint256)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "aggregateValues" | "executeActionPassingKYD" | "extractTimestampsAndAssertAllAreEqual" | "getAuthorisedSignerIndex" | "getDataServiceId" | "getPassedKYDValue" | "getUniqueSignersThreshold" | "validateTimestamp"): FunctionFragment;
    encodeFunctionData(functionFragment: "aggregateValues", values: [PromiseOrValue<BigNumberish>[]]): string;
    encodeFunctionData(functionFragment: "executeActionPassingKYD", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "getPassedKYDValue", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "executeActionPassingKYD", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "getPassedKYDValue", data: BytesLike): Result;
...
export interface SampleKydServiceConsumer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SampleKydServiceConsumerInterface;
    ...
    functions: {
        ...
        executeActionPassingKYD(overrides?: Overrides & {
        ...
        getPassedKYDValue(overrides?: CallOverrides): Promise<[boolean]>;
    ...
    callStatic: {
        aggregateValues(values: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<BigNumber>;
        executeActionPassingKYD(overrides?: CallOverrides): Promise<void>;
        extractTimestampsAndAssertAllAreEqual(overrides?: CallOverrides): Promise<BigNumber>;
        getAuthorisedSignerIndex(signerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<number>;
        getDataServiceId(overrides?: CallOverrides): Promise<string>;
        getPassedKYDValue(overrides?: CallOverrides): Promise<boolean>;
    ...
    estimateGas: {
        ...
        getPassedKYDValue(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getPassedKYDValue(overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=SampleKydServiceConsumer.d.ts.map