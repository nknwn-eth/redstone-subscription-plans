...
exports.resolveDataServiceUrls = void 0;
...
const REDSTONE_DATA_SERVICES_URLS = {
...
const resolveDataServiceUrls = (dataServiceId, opts) => {
    ...
    return gateways
        .filter((gateway) => (!opts?.historical || gateway.historical) &&
        (!opts?.metadata || gateway.metadata))
        .map((gw) => gw.url);
};
exports.resolveDataServiceUrls = resolveDataServiceUrls;
//# sourceMappingURL=data-services-urls.js.map